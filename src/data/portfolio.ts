...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    contributions: [
      ...
      "Ensured accurate form validation, error handling, and edge-case management across user journeys",
      "Supported testing and deployment of new features, resolving usability and functional issues in collaboration with QA teams",
    ],
    chips: ["React", "Redux", "TypeScript", "Kotlin", "REST APIs"],
    highlights: [],
    active: false,
  },
  {
    ...
    client: "FDM • DBS",
    desc: "Developed responsive web interfaces to display users’ FX portfolio analysis and transaction history visualization",
    contributions: [
      "Built and maintained responsive data tables and dashboards using AG Grid to improve readability and usability",
      "Optimized user interfaces to enhance data presentation and ensure smooth interaction with large datasets displayed",
      "Built and integrated RESTful APIs to support seamless data exchange",
    ],
